...
def plot_all(save=False):
    ...
    ax.plot([r_baseline[0], r_intermediate[0], x], 
            [a_baseline[0],  a_intermediate[0], y], 
            color="C1", linestyle="--", linewidth=LW-0.5, zorder=-np.inf)
    
    x, y = scatter_result[20]
    ax.plot([r_baseline[1], r_intermediate[1], x], 
            [a_baseline[1],  a_intermediate[1], y], 
            color="C3", linestyle="--", linewidth=LW-0.5, zorder=-np.inf)
    
    x, y = scatter_result[50]
    ax.plot([r_baseline[2], r_intermediate[2], x], 
            [a_baseline[2],  a_intermediate[2], y], 
    ...
    ax.text(0.725-a, -0.11, "Strong Coupling", fontsize=7, ha="left", va="center")

    ax.plot([0.719-a], [-0.15], marker="^", color="k", ls="", label="Weak Coupling", ms=MS)
    ax.text(0.725-a, -0.15, "Weak Coupling", fontsize=7, ha="left", va="center")

    ax.plot([0.719-a], [-0.19], marker="d", color="k", ls="", label="No Coupling", ms=MS)
    ax.text(0.725-a, -0.19, "No Coupling", fontsize=7, ha="left", va="center")
