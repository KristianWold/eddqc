...
def plot_all(save=False):
    ...
    ax.plot([0.719], [-0.11], marker="o", color="k", ls="", label="Strong Coupling", ms=MS)

    ax.plot([0.719], [-0.15], marker="^", color="k", ls="", label="Weak Coupling", ms=MS)
    ax.plot([0.719], [-0.19], marker="d", color="k", ls="", label="No Coupling", ms=MS)
