...
def plot_circuit(ax):
    ...
    ax.add_artist(brace)
    ax.text(x0 - 0.1, 0.278, r"$\rho_{\rm in}$", ha="center", va="center", color="k")
    ...
    ax.add_artist(brace)
    ax.text(x0 + 0.81, 0.278, r"$\rho_{\rm out}$", ha="center", va="center", color="k")
...
def plot_diagram(ax):
    ...
    rs = np.array([0.02 , 0.026, 0.05 , 0.045, 0.073, 0.108, 0.102, 0.044, 0.057, 0.033, 0.07 , 0.085, 0.036, 0.064, 0.107, 0.05 , 0.127, 0.135, 0.104, 0.14 ,
       0.094, 0.058, 0.089, 0.045, 0.128, 0.019, 0.047, 0.102, 0.001, 0.077])  # fmt:skip
    thetas = np.array([1.031, -1.195, 2.589, -1.592, 1.621, 1.698, 0.396, 1.953, -1.135, -1.48, -1.059, -0.221, 2.154, 2.395, 1.925, 2.47, 1.925, 2.694, -0.098, 0.994, 0.144, -2.055, -3.002, 1.523, 0.274, -1.441, -0.572, -2.763, 1.092, -2.226])  # fmt:skip
