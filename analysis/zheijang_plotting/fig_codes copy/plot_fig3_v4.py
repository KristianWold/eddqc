...
def plot_all(save=False):
    ...
    ag_scatter.set_xlabel(r"$\mathsf{\langle}r\mathsf{\rangle}$", fontsize=FONTSIZE)
    ag_scatter.set_ylabel(
        r"$\mathsf{\langle}-{\rm cos(\theta)}\mathsf{\rangle}$", fontsize=FONTSIZE
    )
    ...
    ag_dist.set_xlabel(
        r"$r$", fontsize=FONTSIZE, axes=[0, 1, 2], sharex=1, labelpad=0.5
    )
    ag_dist.set_ylabel(r"$P(r)$", fontsize=FONTSIZE, axes=[0, 1, 2], sharey=1)
    xs = [0, 0.5, 1]
    ys = [0.0, 1.5, 3.0]
    ag_dist.set_xticks(
        xs, xlim=xs, fontsize=FONTSIZE, sharex=1, xlim_pad_ratio=0.05, axes=[0, 1, 2]
    )
    ag_dist.set_yticks(
        ys, ylim=ys, fontsize=FONTSIZE, sharey=1, ylim_pad_ratio=0.05, axes=[0, 1, 2]
    )
    ...
    ag_dist.set_xlabel(
        r"$\theta$", fontsize=FONTSIZE, axes=[3, 4, 5], sharex=1, labelpad=0.5
    )
    ag_dist.set_ylabel(r"$P(\theta)$", fontsize=FONTSIZE, axes=[3, 4, 5], sharey=1)
    xs = [-np.pi, 0.0, np.pi]
    ys = [0, 0.2, 0.4]
    ag_dist.set_xticks(
        xs,
    ...
    ag_dist.set_yticks(
        ys, ylim=ys, fontsize=FONTSIZE, sharey=1, ylim_pad_ratio=0.05, axes=[3, 4, 5]
    )
